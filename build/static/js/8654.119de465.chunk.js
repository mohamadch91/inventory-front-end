/*! For license information please see 8654.119de465.chunk.js.LICENSE.txt */
"use strict";
  ...
  [8654],
  {
    ...
    38654: function (t, e, r) {
      ...
      var n = r(74165),
        ...
        u = r(59909),
        l = r(72791),
        h = ["arabic", "english", "persian", "french", "russian"],
        f = ["admin", "index", "Facility_info", "Facility_type", "admin_guide"],
        d = r(80794),
        p = r(80184);
      var v = function () {
        var t = (0, l.useState)(h[0]),
          e = (0, i.Z)(t, 2),
          r = e[0],
          v = e[1],
          m = (0, l.useState)(f[0]),
                ...
                return (0, n.Z)().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.next = 2), c.Z.getHelpContent(r, g);
                      case 2:
                        return (
                          (e = t.sent),
                          t.abrupt("return", e.data.length > 0 ? e.data[0] : {})
                        );
                      case 4:
                      case "end":
                        return t.stop();
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          e.preventDefault(),
                          (o = new FormData()).append("lang", r),
                          o.append("page", g),
                          o.append("abr", j),
                          Z.id && o.append("id", Z.id),
                          (t.next = 8),
                          Z.id ? c.Z.putHelpContent(o) : c.Z.postHelpContent(o)
                        );
                      case 8:
                        t.sent, k();
                      case 10:
                            ...
                            (0, p.jsx)("div", {
                              ...
                              children: (0, p.jsxs)(a.Z.Group, {
                                ...
                                children: [
                                  ...
                                  (0, p.jsx)("div", {
                                    className: "col-sm-12",
                                    children: (0, p.jsx)(a.Z.Control, {
                                      onChange: function (t) {
                                        return v(h[t.target.value]);
                                      },
                                      ...
                                      children: h.map(function (t, e) {
                                        return (0,
                                        p.jsx)("option", { value: e, children: t });
                                      }),
                                    }),
                                  }),
                                ],
    ...
    74165: function (t, e, r) {
      ...
      function o() {
        ...
        var x = (v.prototype = d.prototype = Object.create(m));
        function w(t) {
...
//# sourceMappingURL=8654.119de465.chunk.js.map
