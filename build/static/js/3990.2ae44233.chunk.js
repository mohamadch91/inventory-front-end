  ...
  [3990],
  {
    ...
    63990: function (e, t, a) {
      ...
      function z() {
        ...
        return null === a ? null : (0, A.jsx)(A.Fragment, {});
      }
          ...
          ge = function () {
            ...
            t.forEach(function (t) {
              !t.required ||
                ...
                ("bool" === t.type
                  ? void 0 === L[t.stateName] &&
                    (e[t.stateName] = "this field is required!")
                  : (e[t.stateName] = "this field is required!"));
            }),
            j)) {
              var l = j[a];
              console.log(typeof L[a]),
                "is_suitable" === a
                  ? !0 === L[a] &&
            ...
            return P(e), Object.keys(e).length > 0;
          },
          be = function () {
            ge() ||
              F(function (e) {
        ...
        return (0, A.jsxs)("form", {
          ...
          children: [
            (0, A.jsx)("h3", {
              ...
              children: (0, A.jsx)(N.c, { children: "Facility information" }),
            }),
            (0, A.jsx)("div", {
              className: "mt-3",
                    ...
                    (0, A.jsx)("div", {
                      ...
                      children: (0, A.jsx)(v.Z, {
                        ...
                        children: Object.keys(ve).map(function (e, t) {
                          return (0,
                          A.jsx)(h.Z, { children: (0, A.jsx)(f.Z, { style: { width: "max-content" }, children: e }) }, e);
                        }),
                      }),
                    }),
                    (0, A.jsx)(S.Z, {
                      ...
                      isNextDisabled: Object.keys(U).length > 0,
                    }),
                  ],
                }),
              }),
                  ...
                  children:
                    null === (e = Object.values(ve)[k]) || void 0 === e
                      ...
                      : e.map(function (e) {
                          ...
                          var t = !!U[e.stateName];
                          return (0,
                          A.jsxs)(x.Z.Group, { className: "row mb-0", children: [(0, A.jsx)("label", { className: "col-sm-4  ".concat(e.required ? "control-label" : ""), style: { display: "flex", justifyContent: "flex-end", alignItems: "center", lineHeight: "1.4", textAlign: "right" }, children: e.name }), (0, A.jsxs)("div", { className: "col-sm-8", children: ["gpsCordinate" === e.stateName ? (0, A.jsxs)("div", { className: "map  ", children: [(0, A.jsx)("div", { className: "mb-2", children: (0, A.jsx)(x.Z.Control, { type: "text", disabled: !0, value: L[e.stateName] }) }), (0, A.jsxs)("div", { className: "map", children: [console.log(ie, ce), null !== ae && ie && ce && (0, A.jsxs)(w.h, { center: [ie, ce], zoom: 10, scrollWheelZoom: !0, style: { width: "100%", height: "450px", zIndex: "1" }, children: [(0, A.jsx)(C.I, { url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", width: 500 }), (0, A.jsx)(X, { change: Ze, fields: L, setFields: q, map: W, setMap: Y }), (0, A.jsx)(A.Fragment, { children: W && (0, A.jsx)(O.J, { position: W, draggable: !0, children: (0, A.jsxs)(I.G, { position: W, children: ["Current location:", " ", (0, A.jsx)("pre", { children: JSON.stringify(W, null, 2) })] }) }) }), (0, A.jsx)(z, {})] })] })] }) : (0, A.jsx)(g.Z, { field: e, onChangeHandler: ye, defaultValue: L[e.stateName], separator: "childrennumber" === e.stateName || "loverlevelfac" === e.stateName || "populationnumber" === e.stateName }), (0, A.jsx)("br", {}), "General population" === JSON.parse(localStorage.getItem("country")).poptarget && "populationnumber" === e.stateName && Se && (0, A.jsxs)("p", { children: ["range: ", (0, Z.k)(null === Se || void 0 === Se ? void 0 : Se.minpop), " -", " ", (0, Z.k)(null === Se || void 0 === Se ? void 0 : Se.maxpop)] }), "Under-1 Population" === JSON.parse(localStorage.getItem("country")).poptarget && "childrennumber" === e.stateName && Se && (0, A.jsxs)("p", { children: ["range: ", (0, Z.k)(null === Se || void 0 === Se ? void 0 : Se.minpop), " -", " ", (0, Z.k)(null === Se || void 0 === Se ? void 0 : Se.maxpop)] })] }), t && (0, A.jsxs)("div", { className: "row", children: [(0, A.jsx)("div", { className: "col-sm-4" }), (0, A.jsx)("div", { className: "col-sm-8", children: (0, A.jsx)("p", { className: "my-1 ml-2 text-danger", children: U[e.stateName] }) })] }), (0, A.jsx)("hr", { className: "my-3" })] }, e.name);
                        }),
                }),
              }),
            }),
...
//# sourceMappingURL=3990.2ae44233.chunk.js.map
