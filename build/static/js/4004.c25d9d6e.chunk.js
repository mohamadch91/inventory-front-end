    ...
    4004: function (e, n, t) {
      ...
      n.default = function () {
        var e,
          ...
          ie = ee.refetch,
          re = (0, v.useQuery)(
            ["related-item-type", null === _ || void 0 === _ ? void 0 : _.id],
            (0, c.Z)(
              (0, a.Z)().mark(function e() {
                var n;
                return (0, a.Z)().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.next = 2), C.Z.getRelatedItemType(_.id);
                      case 2:
                        return (n = e.sent), e.abrupt("return", n.data);
                      case 4:
                      case "end":
          ...
          ae = function (e, n, t) {
            var s = e.target.checked,
              ...
              c = T.findIndex(function (e) {
                return e.itemtypeid === _.id && e.fieldid === n.id;
              });
              ...
              (0, a.Z)().mark(function e() {
                return (0, a.Z)().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.next = 2), C.Z.putRelatedItemType(T);
                      case 2:
                        e.sent;
                      case 3:
                      case "end":
                              ...
                              children: [
                                ...
                                (0, S.jsx)("div", {
                                  ...
                                  children: (0, S.jsx)(p.Z.Control, {
                                    onChange: function (e) {
                                      q(Y[e.target.value]),
                                        E(Y[e.target.value].item_type[0]);
                                    },
...
//# sourceMappingURL=4004.c25d9d6e.chunk.js.map
