      ...
      <footer className="footer">
        <div className="container-fluid">
          <div className="d-sm-flex justify-content-center justify-content-sm-between py-2 w-100">
            <span className="text-muted text-center text-sm-left d-block d-sm-inline-block"><span>Copyright</span> © <a href="https://www.bootstrapdash.com/" target="_blank" rel="noopener noreferrer"><span>bootstrapdash.com</span> </a>2020</span>
