  ...
  render () {
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          <li className="nav-item nav-category"><span>Main</span></li>
          ...
          <li className="nav-item nav-category"><span>Admin setting </span></li>
          <li className={ this.isPathActive('/setting') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.settingsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('settingsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><span>Settings</span></span>
            ...
            <Collapse in={ this.state.settingsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item"> <Link className={ this.isPathActive('/settings/new-level-list') ? 'nav-link active' : 'nav-link' } to="/settings/new-level-list"><span>level list</span></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className="nav-item nav-category"><span>UI Features</span></li>
          <li className={ this.isPathActive('/basic-ui') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.basicUiMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/buttons') ? 'nav-link active' : 'nav-link' } to="/basic-ui/buttons"><span>Buttons</span></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/dropdowns') ? 'nav-link active' : 'nav-link' } to="/basic-ui/dropdowns"><span>Dropdowns</span></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/typography') ? 'nav-link active' : 'nav-link' } to="/basic-ui/typography"><span>Typography</span></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/icons') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.iconsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/icons/mdi') ? 'nav-link active' : 'nav-link' } to="/icons/mdi"><span>Material</span></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/form-elements') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.formElementsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/form-elements/basic-elements') ? 'nav-link active' : 'nav-link' } to="/form-elements/basic-elements"><span>Basic Elements</span></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className="nav-item nav-category"><span>Data Representation</span></li>
          <li className={ this.isPathActive('/charts') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.chartsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/charts/chart-js') ? 'nav-link active' : 'nav-link' } to="/charts/chart-js"><span>Chart Js</span></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/tables') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.tablesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/tables/basic-table') ? 'nav-link active' : 'nav-link' } to="/tables/basic-table"><span>Basic Table</span></Link></li>
              </ul>
            </Collapse>
          </li>
          ...
          <li className={ this.isPathActive('/error-pages') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.errorPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('errorPagesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><span>Error pages</span></span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={ this.state.errorPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/error-pages/error-404') ? 'nav-link active' : 'nav-link' } to="/error-pages/error-404"><span>404</span></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/error-pages/error-500') ? 'nav-link active' : 'nav-link' } to="/error-pages/error-500"><span>500</span></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className="nav-item documentation-link">
            <a className="nav-link" href="http://bootstrapdash.com/demo/connect-plus-react-free/documentation/documentation.html">
              ...
              <span className="menu-title"><span>Documentation</span></span>
            </a>
          </li>
                ...
                <div>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="sidebar-profile-text">
                      <p className="mb-1"><span>Henry Klein</span></p>
                    </div>
                  </div>
                </div>
          ...
          <li className="nav-item sidebar-user-actions">
            <div className="sidebar-user-menu">
              <a href="!#" onClick={event => event.preventDefault()} className="nav-link"><i className="mdi mdi-speedometer menu-icon"></i>
                <span className="menu-title"><span>Take Tour</span></span></a>
            </div>
          </li>
          <li className="nav-item sidebar-user-actions">
            <div className="sidebar-user-menu">
              <a href="!#" onClick={(event) => {
               EventBus.dispatch("logout")}} className="nav-link"><i className="mdi mdi-logout menu-icon"></i>
                <span className="menu-title"><span>Log Out</span></span></a>
            </div>
          </li>
        </ul>
      </nav>
