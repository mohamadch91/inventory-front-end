          ...
          <li className={ this.isPathActive('/setting') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.settingsMenuOpen }>
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item"> <Link className={ this.isPathActive('/settings/new-level-list') ? 'nav-link active' : 'nav-link' } to="/settings/level-list"><span>level list</span></Link></li>
              </ul>
            </Collapse>
          </li>
